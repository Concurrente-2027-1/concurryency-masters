...
\begin{itemize}
    \item \textbf{Eduardo}: \\\includegraphics[width=16cm]{imagenes/EduardoP3.png}
...
El código fuente es el del archivo DeterminanteConcurrenteDosHilos.java. 
...
\subsection*{7. Compara las 3 implementaciones: el programa \textit{Determinante} concurrente para dos hilos, para seis hilos y el programa secuencial. Responde: ¿A qué se debe el orden en el que se ordenan los
